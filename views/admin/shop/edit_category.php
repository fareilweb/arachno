    ...
    <form name="edit_category_form" method="post" action="<?=Config::$web_path?>/Admin/categoryProcess" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="category_image_preview">
                        <?php if($this->category->category_image_src != ""):?>
                            <img src="<?=Config::$web_path . $this->category->category_image_src;?>" />
                        <?php endif;?>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="category_slug" value="<?=$this->category->category_slug?>" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        <div class="form-group">
                            ...
                            <label>
                                <input type="radio" name="category_status" value="1" <?=($this->category->category_status==1) ? "checked" : "";?> class="form-control" /> 
                                <?=Lang::$available?>
                            </label> 
                            <label>
                                <input type="radio" name="category_status" value="0" <?=($this->category->category_status==0) ? "checked" : "";?> class="form-control" /> 
                                <?=Lang::$unavailable?>
                            </label>
                            <br/><br/>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-4 col-md-4 col-lg-2">
                <div class="form-group">
                    <button type="submit" value="edit_category_submit" class="btn btn-info">
